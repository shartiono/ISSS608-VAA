...
### **1 Original Data Visualization: Population pyramid (Sex vs Age)**
...
### 2 Original Visualization: **Top 20 most popular planning areas with elderly population shown**
...
-   Misleading data due to insufficient data cleaning and preparation.
...
-   Sorting and chart type 
The chart should be sorted by elderly population, not total population, to match its stated purpose. Using a stacked bar chart (rather than side-by-side horizontal barbars) would better show the elderly count in relation to the total population within each planning area.
...
plot_data <- top_areas %>%
  ...
  mutate(PA = fct_reorder(PA, Elderly, .desc = FALSE))  # Bedok on top
