...
::: {.callout-note title="Answer — Evidence of Bias in TROUT & FILAH"}
Yes, both datasets show evidence of bias through **selective inclusion of members**, **inconsistent sentiment representation**, and **narrative alignment gaps**.

-   **FILAH** omits key members and includes only tourism-leaning sentiment, despite claiming fishing advocacy.

-   **TROUT** includes strong pro-fishing voices, possibly to downplay or redirect accusations.

These findings indicate each group may be using incomplete or filtered data to reinforce their agenda, confirming concerns of bias in both TROUT and FILAH datasets.
:::
