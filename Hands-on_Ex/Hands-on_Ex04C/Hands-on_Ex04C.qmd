...
Visualizing uncertainty is relatively new in statistical graphics. In this exercise, we will gain hands-on experience on creating statistical graphics for visualising uncertainty. By the end of this exercise we will be able:
...
::: {.callout-important title="<strong>Things to learn from the code chunk above</strong>"}
...
## **4 Visualizing Uncertainty: ggdist package**
